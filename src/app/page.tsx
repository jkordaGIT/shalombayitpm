...
function Hero() {
  return (
    <section className="relative min-h-screen flex items-end pb-24 pt-20">
      {/* Photo placeholder — replace with full-bleed golden-hour Jerusalem photo */}
      <div
        className="absolute inset-0"
        style={{ background: "linear-gradient(135deg, #4A3F35 0%, #3a2e25 50%, #1e1a16 100%)" }}
        aria-hidden="true"
      >
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to top, rgba(74,63,53,0.8) 0%, transparent 60%)" }}
        />
      </div>
